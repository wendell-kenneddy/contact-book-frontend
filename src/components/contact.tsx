...
export function Contact({
  ...
  return (
    <li className="w-full text-zinc-100/50 hover:text-zinc-100/100 grid items-center grid-cols-3 md:grid-cols-4 bg-zinc-900 rounded-md py-2 px-4 shadow-lg">
      <span className="text-xs md:text-sm text-center">{name}</span>

      <span className="text-xs md:text-sm sr-only md:not-sr-only text-center">{email}</span>

      <span className="text-xs md:text-sm text-center">{phoneNumber}</span>
